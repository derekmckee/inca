package inca.utils {
	...
	public class DisplayUtils {
		...
		public static function getBitmapReflection(value:BitmapData):BitmapData{
			var bmReflection:BitmapData = new BitmapData(value.width, value.height, true, 0);
			...
			var flipM:Matrix = new Matrix(1, 0, 0, -1, 0, value.height);
			bmReflection.draw(res, flipM);
